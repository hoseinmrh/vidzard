import json
import os
from src.utils.video_utils import cut_segment, save_individual_clip, concat_segments
...
def create_highlight_video(video_path, transcript, segment_ids, output_path):
    """Creates a highlight video from specified segments using modular ffmpeg subprocess calls."""
    temp_files = []
